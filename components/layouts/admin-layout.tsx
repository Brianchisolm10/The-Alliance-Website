...
export const AdminLayout: React.FC<AdminLayoutProps> = ({ children, userName }) => {
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 transform bg-gray-900 text-white shadow-lg transition-transform duration-300 ease-in-out lg:static lg:translate-x-0 ${
          ...
          <div className="border-t border-gray-800 p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <Link href="/api/auth/signout" className="text-xs text-gray-400 hover:text-gray-300">
                  Sign out
                </Link>
              </div>
            </div>
