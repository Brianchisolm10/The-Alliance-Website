      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="col-span-1">
            <h3 className="text-2xl font-bold text-blue-400">AFYA</h3>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link href="/tools" className="text-sm text-gray-400 hover:text-white">
                  Tools
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link href="/impact" className="text-sm text-gray-400 hover:text-white">
                  Impact
                </Link>
              </li>
              <li>
                <Link href="/impact/donate" className="text-sm text-gray-400 hover:text-white">
                  Donate
                </Link>
              </li>
              <li>
                <Link href="/impact/gear-drive" className="text-sm text-gray-400 hover:text-white">
                  Gear Drive
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 border-t border-gray-800 pt-8">
          <p className="text-center text-sm text-gray-400">
            &copy; {currentYear} AFYA Wellness. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
